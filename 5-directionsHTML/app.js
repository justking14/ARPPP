...
var bridget01 = new Audio("audio/Chapel_soundbite.mp3");
...
// 
// Bridget:
function setupDishPantry(){
    var imageElement = document.getElementById("currentImage");
    imageElement.src = "Local Wedding.png";
    ...
    //setTimeout(askAboutWork(), 20000);
			setTimeout(function() { askAboutWork(); }, 14500);
...
function buttonPressed(){
	//if(currentButton == "toBridget01") {askAboutWork();}
	//askAboutWork()
}
